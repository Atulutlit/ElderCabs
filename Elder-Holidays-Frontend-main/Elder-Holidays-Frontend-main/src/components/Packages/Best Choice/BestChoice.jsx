...
import slide1 from "../../../assets/img/packages/bestChoice.png";
import slide2 from "../../../assets/img/packages/bestChoice.png";
import slide3 from "../../../assets/img/packages/bestChoice.png";
...
export const BestChoice = () => {
  ...
  return (
    <div className="BestChoice_container flex justify-center items-start  lg:mt-20 md:my-4 mt-10  ">
      <Modal
        open={Open}
        onClose={handleClose}
      ...
      <div className="flex justify-between items-center flex-col  w-11/12 flex-wrap bg-inherit">
        ...
        <div className="flex justify-center items-center w-full lg:w-11/12  lg:my-14 md:my-10 mt-7 ">
          <Slider
            {...settings}
            className="flex justify-between items-center w-full lg:w-11/12"
          >
            {slider.map((slide, index) => (
              <div className=" w-4/6 lg:h-[280px] h-[520px] md:h-[400px]" key={index}>
                <div
                  className=" shadow-xl w-full lg:w-11/12 px-3 py-3 h-[520px] flex justify-center items-center  lg:h-[260px]  lg:flex-nowrap flex-wrap"
                  style={{
                    borderRadius: "10px",
                  }}
                >
                  ...
                  <img
                    ...
                    alt="img"
                  />
                  <div className="ml-3 text-left w-[93%]   px-2  py-5 flex justify-center  flex-col lg:h-full ">
                    <p style={{ color: "#069BCA" }} className="mb-3">
                      Domestic Flight
                    </p>
                    <p className=" text-xl">
                      Hugs savings on flight with trxvl.
                    </p>
                    <p style={{ color: "#069BCA" }} className="my-3 text-sm">
                      Book domestic flights starting @ just $145.00
                    </p>
                    <div>
                      <button onClick={handleOpen}
                        className="BestChoice_button px-4 py-1 text-base font-thin   ">
                        Book Now
                      </button>
                    </div>
                  </div>
