...
export const SpecialOffers = () => {
  ...
  return (
    <div className="PopularPlace_container flex justify-center items-start	 lg:my-10 md:my-10 mt-10  h-full  ">
      ...
      {/* <div className="PopularPlace_container flex justify-center items-start	 lg:my-10 md:my-10 mt-10   lg:h-[90vh]  md:h[70vh] h-[86vh] bg-green-800 "> */}
      {/* Both heading and slider container */}
      <div className="flex justify-center items-center flex-col w-full lg:w-11/12 flex-wrap">
        <div className="flex justify-between items-center lg:w-11/12 w-full flex-wrap">
          <div
            className="lg:text-4xl text-3xl font-semibold ml-10 md:ml-0"
            style={{ color: "#20284F" }}
          >
            Special Offers{" "}
          </div>
          {/* <div className="flex justify-between items-center PopularPlace_links flex-wrap text-lg lg:my-0 my-5">
            <button className="mx-5  cursor-pointer">Family</button>
            <button className="mx-5  cursor-pointer">Couple</button>
            <button className="mx-5  cursor-pointer">Teams</button>
          </div> */}
        </div>
        <div className="flex justify-center items-center w-full	">
          ...
          >
            {slider.map((slide, index) => (
              <div className=" w-4/6 h-[500px] md:h-[420px]  " key={index}>
                <div
                  className=" shadow-xl w-6/6 mx-2 flex justify-center items-center flex-col h-[450px] md:h-[410px] "
                  style={{
                    borderRadius: "10px",
                  }}
                >
                  <div className=" relative flex justify-center items-center  ">
                    <p
                      className="absolute top-3 right-6 font-thin"
                      style={{ color: "#fff" }}
                    >
                      4.5
                    </p>
                  ...
                  <div className="text-left w-full   px-2  py-2 flex justify-center  flex-col">
                    <div
                      className="text-left w-[93%]   px-2  py-1 flex justify-center  flex-col"
                      style={{
                        borderRadius: "0px 0px 10px 10px",
                      }}
                    >
                      <p className="font-base text-xl">{slide.name}</p>
                      <p style={{ color: "#787878" }} className="text-xs ">
                        {slide.place}
                      </p>
                    </div>
                    <div className="flex justify-around items-end my-2 ">
                      <div className="font-thin text-lg flex justify-center items-center mb-2">
                        <p className="pl-1 text-xl font-extrabold">
                          {slide.cost}
                          <span
                            style={{ color: "#787878" }}
                      ...
                      <div className="flex justify-between items-center">
                        <button
                          onClick={handleOpen}
                          className="SpecialOffers_button px-6 py-1 text-lg  "
                        >
                          Book
                        </button>
                      </div>
