...
export const TopDestination = () => {
  ...
  return (
    <div className="TopDestination_container flex justify-center items-start  lg:my-0 md:my-4 mt-1  ">
      <Modal
        open={Open}
        onClose={handleClose}
      ...
      >
        <Box sx={style}>
          <div className="flex justify-center items-center lg:flex-nowrap flex-wrap lg:w-full w-[80vw]">
            {/* LEFT SIDE */}
            <div className=" lg:mr-4 lg:w-9/12 w-full ">
              ...
              <div className="flex justify-between items-start   lg:my-3 ">
                ...
                <div className="flex justify-center items-center">
                  <img alt="" src={yellowStar} className="mx-1.5 h-[17px]" />
              ...
              <div className=" h-full lg:py-3 w-10/12">
                ...
                <div className="flex justify-between items-center lg:mt-5 mt-2  lg:w-10/12 w-full">
                  <div className="flex justify-center items-center flex-col">
                    <img alt="" src={hotel} className="lg:h-[15px] h-[10px]" />
                    <p className="text-xs text-[#787878]">1 Hotel</p>
                  </div>
                  <div className="flex justify-center items-center flex-col">
                    <img alt="" src={car} className="lg:h-[15px] h-[10px]" />
                    <p className="text-xs text-[#787878]">2 Transfers</p>
                  </div>
                  <div className="flex justify-center items-center flex-col">
                    <img alt="" src={walk} className="lg:h-[15px] h-[10px]" />
      ...
      <div className="flex justify-between items-center flex-col w-full flex-wrap bg-inherit">
        <div className="flex justify-between w-full flex-wrap mt-16">
          <div
            className="lg:text-4xl text-3xl font-semibold ml-10 lg:ml-40"
            style={{ color: "#20284F" }}
          >
            Top Destination{" "}
          </div>
        ...
        <div className="flex justify-center items-center w-full lg:w-11/12  lg:mb-14 lg:mt-5 md:my-10 mt-1 mb-10">
          <Slider
            {...settings}
            className="flex justify-between items-center w-11/12 h-[450px]"
          >
            {slider.map((slide, index) => (
              <div className=" w-4/6 h-[600px] " key={index}>
                <div
                  className=" shadow-xl w-11/12 px-1 py-3 flex justify-center items-center flex-col h-[520px]"
                  style={{
                    borderRadius: "10px",
                  }}
                >
                  {/* <div className="w-[93%] TopDestination_overlay h-screen flex justify-center items-center 10px"  style={{
                    borderRadius: "10px",
                  }}> */}
                  <img alt=""
                    src={slide.bgimg}
                  ...
                  <div className="text-left w-[93%]   px-2  py-5 flex justify-center  flex-col">
                    <div className="flex justify-between items-center my-2">
                      <div className="flex justify-between items-center">
                        ...
                        <p
                          className="lg:pl-1 pl-0 lg:text-xs text-[9px]	"
                          style={{ color: "#787878" }}
                        >
                          Udaipur
                        </p>
                    ...
                    <div className="flex justify-between items-center pt-5 pb-1 " style={{
                      // borderRadius: "0px 0px 10px 10px",
                      paddingBottom: "15px",
                      borderBottom: "3px solid #C0C0C0",
                    }}>
                      <p className="font-thin text-lg flex justify-center items-center">
                        <img alt="" src={star} className="pr-1" />
                        <p>4.9</p>
                      </p>
                      <p className="text-base font-semibold	">$880 - $980</p>
                    </div>
