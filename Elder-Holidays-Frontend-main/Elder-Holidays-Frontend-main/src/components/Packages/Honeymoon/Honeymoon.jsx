    ...
    <div className="Honeymoon_container flex justify-center items-start  lg:mt-20 md:my-4 mt-10  ">
      ...
      <div className="flex justify-between items-center flex-col  w-full flex-wrap bg-inherit">
        <div className="flex justify-between  w-full flex-wrap">
          <div
            className="lg:text-4xl text-3xl font-semibold	lg:ml-36"
            style={{ color: "#20284F" }}
          >
          ...
          >
            {slider.map((slide, index) => (
              <div className=" w-4/6 h-[600px]   " key={index}>
                <div
                  className=" shadow-xl w-full lg:w-11/12 px-1 py-3 flex justify-center items-center flex-col h-[540px]"
                  style={{
                    borderRadius: "10px",
                  }}
                >
                  ...
                  <div className="text-left w-[93%]   px-2  py-5 flex justify-center  flex-col">
                    ...
                    <div
                      className="flex justify-between items-center pt-5 pb-1 "
                      style={{
